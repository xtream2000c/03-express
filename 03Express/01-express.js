...
const user = 'Carlos';
const password = 'HhhbmYS76s31ZM7i';
const dbname = 'Mapas';
const uri = `mongodb+srv://${user}:${password}@cluster0.ojxco.mongodb.net/${dbname}?retryWrites=true&w=majority`; //URL de conexión, que completaremos luego
